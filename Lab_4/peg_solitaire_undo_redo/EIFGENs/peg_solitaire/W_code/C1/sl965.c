/*
 * Code for class SLOT_STATUS_ACCESS
 */
...
extern EIF_TYPED_VALUE F965_7130(EIF_REFERENCE);
extern EIF_TYPED_VALUE F965_7131(EIF_REFERENCE);
extern EIF_TYPED_VALUE F965_7132(EIF_REFERENCE);
extern void F965_7823(EIF_REFERENCE, int);
...
RTOID (F965_7130)
EIF_TYPED_VALUE F965_7130 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 964, Current, 0, 0, 13437);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(964, Current, 13437);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F965_7131)
EIF_TYPED_VALUE F965_7131 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 964, Current, 0, 0, 13438);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(964, Current, 13438);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F965_7132)
EIF_TYPED_VALUE F965_7132 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 964, Current, 0, 0, 13439);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(964, Current, 13439);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F965_7823 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 964, Current, 0, 7822);
	RTSA(dtype);
	RTME(dtype, 0);
...
{
	GTCX
	RTOTS (7130,F965_7130)
	RTOTS (7131,F965_7131)
	RTOTS (7132,F965_7132)
}
