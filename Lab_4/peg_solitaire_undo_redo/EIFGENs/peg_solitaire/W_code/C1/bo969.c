...
extern EIF_TYPED_VALUE F969_7166(EIF_REFERENCE);
extern void F969_7825(EIF_REFERENCE, int);
...
RTOID (F969_7166)
EIF_TYPED_VALUE F969_7166 (EIF_REFERENCE Current)
{
	GTCX
...
void F969_7825 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 968, Current, 0, 7824);
	RTSA(dtype);
	RTME(dtype, 0);
