...
static const EIF_TYPE_INDEX egt_13_981 [] = {0xFF01,971,0xFFFF};
...
static const struct desc_info desc_981[] = {
	...
	{EIF_GENERIC(egt_13_981), 13595, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_981), 13596, 0xFFFFFFFF},
};
void Init981(void)
{
	IDSC(desc_981, 0, 980);
	IDSC(desc_981 + 1, 1, 980);
	IDSC(desc_981 + 32, 404, 980);
}
