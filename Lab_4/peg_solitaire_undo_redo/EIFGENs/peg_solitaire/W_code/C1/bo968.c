...
extern void F968_7825(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 0, 0, 13467);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(967, Current, 13467);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F968_7825 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 967, Current, 0, 7824);
	RTSA(dtype);
	RTME(dtype, 0);
