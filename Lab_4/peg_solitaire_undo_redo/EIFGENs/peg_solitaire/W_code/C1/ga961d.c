...
static const EIF_TYPE_INDEX egt_1_961 [] = {0xFF01,1014,960,0xFFFF};
...
static const EIF_TYPE_INDEX egt_13_961 [] = {0xFF01,960,0xFFFF};
static const EIF_TYPE_INDEX egt_14_961 [] = {0xFF01,966,0xFFFF};
...
static const struct desc_info desc_961[] = {
	...
	{EIF_GENERIC(egt_14_961), 13385, 0xFFFFFFFF},
};
void Init961(void)
{
	IDSC(desc_961, 0, 960);
	IDSC(desc_961 + 1, 1, 960);
	IDSC(desc_961 + 32, 365, 960);
}
