...
extern void F997_7450(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F997_7451(EIF_REFERENCE);
...
void F997_7450 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 996, Current, 0, 2, 13695);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(996, Current, 13695);
	RTCC(arg1, 996, l_feature_name, 1, eif_new_type(231, 0x01), 0x01);
	{
		...
		RTCC(arg2, 996, l_feature_name, 2, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5246, 0xF8000159, 0); /* case */
	RTAR(Current, arg2);
...
void F997_7451 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 996, Current, 3, 0, 13696);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(996, Current, 13696);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
...
EIF_TYPED_VALUE F997_7452 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 996, Current, 0, 0, 13697);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(996, Current, 13697);
	RTIV(Current, RTAL);
	RTHOOK(1);
