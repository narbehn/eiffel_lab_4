...
extern void F996_7445(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F996_7446(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F996_7447(EIF_REFERENCE);
extern EIF_TYPED_VALUE F996_7448(EIF_REFERENCE);
...
void F996_7445 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 995, Current, 0, 2, 13690);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(995, Current, 13690);
...
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5246, 0xF80000FF, 0); /* case */
	RTAR(Current, arg2);
	*(EIF_REFERENCE *)(Current + RTWA(5246, dtype)) = (EIF_REFERENCE) RTCCL(arg2);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5242, 0xF80000E7, 0); /* case_name */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(5242, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5244, 0xF80000E7, 0); /* violation_tag */
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5244, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 5248, 0xF80000E7, 0); /* expected_tag_name */
	tr1 = RTMS_EX_H("NONE",4,1313820229);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5248, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 5243, 0xF80000E7, 0); /* bookmark_name */
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
...
void F996_7446 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 995, Current, 0, 3, 13691);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(995, Current, 13691);
	RTCC(arg1, 995, l_feature_name, 1, eif_new_type(231, 0x01), 0x01);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,255,0xFF01,0xFFF9,0,185,0xFFFF};
		EIF_TYPE typres0;
	...
	RTCC(arg3, 995, l_feature_name, 3, eif_new_type(231, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F996_7447 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 995, Current, 3, 0, 13692);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(995, Current, 13692);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 5240, 0x04000000, 1); /* passed */
		*(EIF_BOOLEAN *)(Current + RTWA(5240, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	}
	RTVI(Current, RTAL);
	RTRS;
	RTE_E
	...
	if (tb1) {
		RTHOOK(6);
		RTDBGAA(Current, dtype, 5240, 0x04000000, 1); /* passed */
		*(EIF_BOOLEAN *)(Current + RTWA(5240, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	} else {
		RTHOOK(7);
		RTDBGAA(Current, dtype, 5241, 0x04000000, 1); /* contract_violated */
		...
		*(EIF_REFERENCE *)(Current + RTWA(5244, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(10);
		RTDBGAA(Current, dtype, 5245, 0x10000000, 1); /* violation_type */
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1240, dtype))(Current)).it_i4);
		*(EIF_INTEGER_32 *)(Current + RTWA(5245, dtype)) = (EIF_INTEGER_32) ti4_1;
	}
	RTHOOK(11);
...
EIF_TYPED_VALUE F996_7448 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 995, Current, 0, 0, 13693);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(995, Current, 13693);
	RTIV(Current, RTAL);
	RTHOOK(1);
